...
// --- DATOS SIMULADOS (Cambiamos 'capacity' por 'description') ---
const allClassrooms = ref([
    // Aulas de muestra con el nuevo campo 'description'
    { id: 101, zoneId: 1, name: 'Laboratorio de Cómputo 1', description: 'Aula equipada con 25 computadoras All-in-One y aire acondicionado.' },
    { id: 102, zoneId: 1, name: 'Sala de Juntas B', description: 'Sala de reuniones pequeña con proyector y mesa para 10 personas.' },
    { id: 201, zoneId: 2, name: 'Taller de Maquinaria Pesada', description: 'Espacio industrial para prácticas de soldadura y mecánica.' },
    { id: 202, zoneId: 2, name: 'Aula de Diseño CAD', description: '' },
]);
...
// --- ESTADO LOCAL (Cambiamos 'capacity' por 'description') ---
const showClassroomDialog = ref(false);
const classroomForm = ref({ id: null, zoneId: zoneId, name: '', description: '' });
...
const openClassroomDialog = (classroom) => {
    if (classroom.id) {
        // CAMBIO 3: Copia el campo 'description'
        classroomForm.value = { ...classroom }; 
    } else {
        // CAMBIO 4: Inicializa el campo 'description'
        classroomForm.value = { id: null, zoneId: zoneId, name: '', description: '' }; 
    }
...
const saveClassroom = () => {
    if (isEditMode.value) {
        ...
        if (index !== -1) {
            // CAMBIO 5: Guarda el campo 'description'
        ...
        // CAMBIO 6: Crea la nueva aula con 'description'
...
// --- MÉTODO DE NAVEGACIÓN A INVENTARIO (Sin cambios) ---
