<template>
    ...
    <q-page class="q-pa-lg bg-grey-2">
        ...
        <q-breadcrumbs class="text-secondary q-mb-md">
            ...
            <q-breadcrumbs-el :label="currentZoneName" icon="map" :to="`/dashboard/aulas/${zoneId}`"
        ...
        <div class="row items-center q-mb-lg">
            ...
            <q-select dense outlined v-model="categoryFilter" :options="availableCategories"
                label="Filtrar por Categoría" clearable class="bg-white q-mt-sm" style="width: 200px;"
                color="primary" />
        ...
        <div class="row q-col-gutter-lg" v-else>
            ...
            <div v-for="item in filteredItems" :key="item.id" class="col-12 col-sm-6 col-md-4 col-lg-3">

                <q-card class="item-card cursor-pointer" @click="goToItemDetail(item.id)">

                    <q-img :src="item.imageUrl || 'https://cdn.quasar.dev/img/material.png'" height="180px" fit="cover">

                        <q-badge :color="item.available > 0 ? 'positive' : 'negative'" floating
                    ...
                    <q-card-actions align="right">
                        ...
                        <q-btn flat icon-right="info" label="Ver Detalle" color="primary" />
